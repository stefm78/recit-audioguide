...
SCENES = V2 / "scenes" / "SATURDAY_SCENE_PROGRAM.json"
MANIFEST = V2 / "audio" / "SATURDAY_AUDIO_MANIFEST.json"


class SevilleV2SaturdayAudioProductionTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_exact_primary_cardinality_and_optional_depth_boundary(self):
        ...
        self.assertEqual(5, len(self.scene_program["optional_depth"]))
        ...
        audio_programs = sorted((V2 / "audio").glob("SEV2-SAT-*.json"))
