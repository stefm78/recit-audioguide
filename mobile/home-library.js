(() => {
  ...
  const source = Array.isArray(window.RECIT_CATALOG_DATA) ? window.RECIT_CATALOG_DATA : [];
  const editorialCatalog = source.filter(item => item && item.visible !== false);
